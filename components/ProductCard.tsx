...
export default function ProductCard({ product }: ProductCardProps) {
  ...
  return (
    <motion.div
      ...
      className="group relative rounded-2xl p-6 min-h-[400px] flex flex-col justify-between overflow-hidden bg-[rgba(20,20,20,0.6)] backdrop-blur-md border border-gray-700/60 shadow-[0_0_20px_rgba(0,0,0,0.3)] transition-all duration-300 hover:shadow-[0_0_25px_rgba(255,123,0,0.25)]"
