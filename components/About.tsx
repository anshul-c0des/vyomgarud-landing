    ...
    >
      ...
      >
        <h2 className="text-4xl md:text-5xl font-bold mb-6 text-white font-poppins">
          Engineered for the{" "}
          <span className="text-orange-500">Decisive Moment</span>
        </h2>
        <p className="text-lg md:text-xl leading-relaxed text-gray-300">
          VyomGarud designs and deploys{" "}
          <span className="text-white font-semibold">
            cutting-edge, military-grade UAV systems
          </span>
          with unmatched precision and{" "}
          <span className="text-orange-500">futuristic design</span>. Our drones
          combine stealth, durability, and advanced AI to dominate any mission
          scenario.
        </p>
      </motion.div>
