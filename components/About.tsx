  ...
  return (
    ...
    >
      <div className="absolute inset-0 pointer-events-none">
        ...
        <div className="absolute w-1 h-1 bg-orange-500 rounded-full animate-pulse" style={{ top: '30%', left: '65%' }} />
        <div className="absolute w-1 h-1 bg-orange-500 rounded-full animate-pulse" style={{ top: '80%', left: '90%' }} />
      </div>
